# Front-End Görevi: Ürün Oluşturma Talebi Detay Sayfası (Admin Görünümü)
...
**Kullanıcı Hikayesi:** Bir **admin** olarak, **bir ürün oluşturma talebinin detaylarını görüntülemek, ürün bilgilerini incelemek ve talebi kabul etmek, gerekçeli şekilde reddetmek veya revizyon istemek** istiyorum, böylece **yeni ürünlerin yayınlanma sürecini kontrollü bir şekilde yönetebilirim**.
...
| Gereksinim | Açıklama |
|------------|----------|
| **Ürün Bilgileri** | Talep edilen ürün bilgilerinin gösterimi (yeni ürün, karşılaştırma yok) |
...
| Kabul Et sonrası | `#products/urun-olusturma` |
| Reddet sonrası | `#products/urun-olusturma` |
| Revize İste sonrası | `#products/urun-olusturma` |
...
- Sayfa başlığı: "Ürün Oluşturma Talebi #{id} - Admin Paneli"
...
- [ ] `toBeRevised` → Turuncu "Revize Edilecek" + `fa-exclamation-circle`
...
- [ ] Kırmızı temalı bildirim kutusu
...
- [ ] Turuncu temalı bildirim kutusu
...
- [ ] Detaylı mesaj alanı isteğe bağlı
...
**Talep Yönetimi Kuralları (Ürün Oluşturma - Admin):**
